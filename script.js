...
const translations = {
  pt: {
    ...
    "meta.services": "Serviços de sites profissionais, landing pages de conversão, catálogos, lojas virtuais e suporte da Numore Labs.",
    ...
    "common.consultSupport": "Consultar suporte",
    ...
    "home.cardSupport": "Acompanhamento opcional para manter seu site atualizado.",
    ...
    "services.support.title": "Suporte depois do lançamento",
    "services.support.desc": "Acompanhamento opcional para manter o site atualizado, corrigir detalhes, trocar textos, imagens e melhorar seções conforme o negócio evolui.",
    "services.support.b1": "Atualização de textos, imagens e informações.",
    "services.support.b2": "Pequenos ajustes visuais e técnicos.",
    "services.support.b3": "Melhorias em botões, chamadas e seções.",
    "services.support.b4": "Suporte mensal ou por demanda.",
    "form.optionLanding": "Landing page de conversão",
    "form.optionCatalog": "Catálogo ou loja virtual",
    "form.optionSupport": "Suporte depois do lançamento",
  ...
  es: {
    ...
    "meta.services": "Servicios de sitios profesionales, landing pages de conversión, catálogos, tiendas virtuales y soporte de Numore Labs.",
    ...
    "common.consultSupport": "Consultar soporte",
    ...
    "home.cardSupport": "Acompañamiento opcional para mantener tu sitio actualizado.",
    ...
    "services.support.title": "Soporte después del lanzamiento",
    "services.support.desc": "Acompañamiento opcional para mantener el sitio actualizado, corregir detalles, cambiar textos, imágenes y mejorar secciones conforme el negocio evoluciona.",
    "services.support.b1": "Actualización de textos, imágenes e información.",
    "services.support.b2": "Pequeños ajustes visuales y técnicos.",
    "services.support.b3": "Mejoras en botones, llamadas y secciones.",
    "services.support.b4": "Soporte mensual o por demanda.",
    "form.optionLanding": "Landing page de conversión",
    "form.optionCatalog": "Catálogo o tienda virtual",
    "form.optionSupport": "Soporte después del lanzamiento",
  ...
  en: {
    ...
    "meta.services": "Professional websites, conversion landing pages, catalogs, online stores, and support services by Numore Labs.",
    ...
    "common.consultSupport": "Ask about support",
    ...
    "home.cardSupport": "Optional follow-up to keep your website updated.",
    ...
    "services.support.desc": "Optional follow-up to keep the website updated, correct details, replace text and images, and improve sections as the business evolves.",
    "services.support.b1": "Updates to text, images, and information.",
    "services.support.b2": "Small visual and technical adjustments.",
    "services.support.b3": "Improvements to buttons, calls to action, and sections.",
    "services.support.b4": "Monthly or on-demand support.",
    "form.optionLanding": "Conversion landing page",
    "form.optionCatalog": "Catalog or online store",
    "form.optionSupport": "Post-launch support",
