...
const translations = {
  pt: {
    ...
    "meta.portfolio": "Portfólio de projetos preparados para Numore Labs.",
    ...
    "portfolio.heroTitle": "Um espaço pronto para transformar trabalhos reais em prova de confiança.",
    "portfolio.heroText": "Troque estes projetos por capturas reais, segmentos, objetivos, resultados e links quando tiver o material final.",
    "portfolio.card1.tag": "Restaurante",
    "portfolio.card1.title": "Sabor que conecta",
    "portfolio.card2.tag": "Automotivo",
    "portfolio.card2.title": "Performance que impulsiona resultados",
    "portfolio.card3.tag": "Interiores",
    "portfolio.card3.title": "Elegância em cada detalhe",
    "portfolio.card4.tag": "Marketing",
    "portfolio.card4.title": "Marketing digital que gera vendas",
    "portfolio.project1.label": "Projeto 01",
    "portfolio.project2.label": "Projeto 02",
    "portfolio.project3.label": "Projeto 03",
    "portfolio.project4.label": "Projeto 04",
    "portfolio.projectName": "Nome do projeto",
    "portfolio.project1.desc": "Espaço para descrever o problema, a solução criada e o resultado do projeto.",
    "portfolio.project2.desc": "Espaço para adicionar capturas, indústria, alcance e objetivo principal do site.",
    "portfolio.project3.desc": "Espaço para mostrar antes e depois, detalhes visuais e funcionalidades principais.",
    "portfolio.project4.desc": "Espaço para explicar estratégia, peças criadas e próximos passos do caso.",
    "portfolio.similar": "Quero algo similar",
  ...
  es: {
    ...
    "meta.portfolio": "Portafolio de proyectos preparados para Numore Labs.",
    ...
    "portfolio.heroTitle": "Un espacio listo para convertir trabajos reales en prueba de confianza.",
    "portfolio.heroText": "Cambia estos proyectos por capturas reales, rubros, objetivos, resultados y enlaces cuando tengas material final.",
    "portfolio.card1.tag": "Restaurante",
    "portfolio.card1.title": "Sabor que conecta",
    "portfolio.card2.tag": "Automotriz",
    "portfolio.card2.title": "Rendimiento que impulsa resultados",
    "portfolio.card3.tag": "Interiores",
    "portfolio.card3.title": "Elegancia en cada detalle",
    "portfolio.card4.tag": "Marketing",
    "portfolio.card4.title": "Marketing digital que genera ventas",
    "portfolio.project1.label": "Proyecto 01",
    "portfolio.project2.label": "Proyecto 02",
    "portfolio.project3.label": "Proyecto 03",
    "portfolio.project4.label": "Proyecto 04",
    "portfolio.projectName": "Nombre del proyecto",
    "portfolio.project1.desc": "Espacio para describir el problema, la solución creada y el resultado del proyecto.",
    "portfolio.project2.desc": "Espacio para agregar capturas, industria, alcance y objetivo principal del sitio.",
    "portfolio.project3.desc": "Espacio para mostrar antes y después, detalles visuales y funcionalidades principales.",
    "portfolio.project4.desc": "Espacio para explicar estrategia, piezas creadas y próximos pasos del caso.",
    "portfolio.similar": "Quiero algo similar",
  ...
  en: {
    ...
    "meta.portfolio": "Prepared project portfolio for Numore Labs.",
    ...
    "portfolio.heroTitle": "A space ready to turn real work into trust.",
    "portfolio.heroText": "Replace these projects with real screenshots, industries, goals, results, and links when you have final material.",
    "portfolio.card1.tag": "Restaurant",
    "portfolio.card1.title": "Flavor that connects",
    "portfolio.card2.tag": "Automotive",
    "portfolio.card2.title": "Performance that drives results",
    "portfolio.card3.tag": "Interiors",
    "portfolio.card3.title": "Elegance in every detail",
    "portfolio.card4.tag": "Marketing",
    "portfolio.card4.title": "Digital marketing that generates sales",
    "portfolio.project1.label": "Project 01",
    "portfolio.project2.label": "Project 02",
    "portfolio.project3.label": "Project 03",
    "portfolio.project4.label": "Project 04",
    "portfolio.projectName": "Project name",
    "portfolio.project1.desc": "Space to describe the problem, the solution created, and the project result.",
    "portfolio.project2.desc": "Space to add screenshots, industry, scope, and the main website goal.",
    "portfolio.project3.desc": "Space to show before and after, visual details, and core features.",
    "portfolio.project4.desc": "Space to explain strategy, created assets, and next steps for the case.",
    "portfolio.similar": "I want something similar",
